...
<link rel="stylesheet" href="style.css">
<style>
    .product-blocks { display:flex; flex-wrap:wrap; gap:15px; margin-bottom:20px; }
    .product-block {
        border:1px solid #ccc; border-radius:5px; padding:10px; width:120px; text-align:center;
